...
/**
 * Test for transaction WIKJT00101ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT00101ESTest.xml" })
public class WIKJT00101ESTransactionTest {

	@Autowired
	private WIKJT00101ESTransaction transaction;
