...
/**
 * Test for transaction WIKJT12301ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT12301ESTest.xml" })
public class WIKJT12301ESTransactionTest {

	@Autowired
	private WIKJT12301ESTransaction transaction;
