...
/**
 * Test for transaction WIKJT45601ESTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT45601ESTest.xml" })
public class WIKJT45601ESTransactionTest {

	@Autowired
	private WIKJT45601ESTransaction transaction;
